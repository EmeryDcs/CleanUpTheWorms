...
public class ChangeLightmap : MonoBehaviour
{
    ...
    public void Load()
    {
        ...
        for (int i = 0; i < newLightmaps.Length; i++)
        {
            ...
            if (lightingScenariosData.lightmaps[i] != null)
            {
            ...
            {
                if (lightingScenariosData.lightmapsDir != null && i < lightingScenariosData.lightmapsDir.Length && lightingScenariosData.lightmapsDir[i] != null)
                {
                    newLightmaps[i].lightmapDir = Resources.Load<Texture2D>(m_resourceFolder + "/" + lightingScenariosData.lightmapsDir[i].name);
                }
                
                if (lightingScenariosData.lightmapsShadow != null && i < lightingScenariosData.lightmapsShadow.Length && lightingScenariosData.lightmapsShadow[i] != null)
                {
